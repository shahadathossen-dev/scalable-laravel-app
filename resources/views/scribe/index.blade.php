                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-login">POST api/v1/login</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-forget-password">
                                <a href="#endpoints-POSTapi-v1-forget-password">POST api/v1/forget-password</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-validate-reset-token">
                                <a href="#endpoints-GETapi-v1-validate-reset-token">GET api/v1/validate-reset-token</a>
                            </li>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid email address. Must be at least 3 characters. Must not be greater than 255 characters. Example: <code>zbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must match the regex /^(?=.<em>[a-z])(?=.</em>[A-Z])(?=.<em>\d)(?=.</em>[!@#$%^&amp;*()_-+=[]{}:;,.&lt;&gt;?\/|~\&quot;]).{8,}$/. Must be at least 8 characters. Example: <code>-0pBNvYgxw</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="confirm_password"                data-endpoint="POSTapi-v1-register"
               value="architecto"
               data-component="body">
    <br>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid email address. Must be at least 3 characters. Must not be greater than 255 characters. Example: <code>gbailey@example.net</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be at least 1 character. Must not be greater than 255 characters. Example: <code>+-0pBNvYgxwmi/#iw</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>true</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-forget-password">POST api/v1/forget-password</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/v1/forget-password" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"email\": \"gbailey@example.net\"
...
<p>Must be a valid email address. Must be at least 3 characters. Must not be greater than 255 characters. Example: <code>gbailey@example.net</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-validate-reset-token">GET api/v1/validate-reset-token</h2>
...
<span id="example-requests-GETapi-v1-validate-reset-token">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/v1/validate-reset-token" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"token\": \"architecto\"
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/v1/validate-reset-token"
);
...
<span id="example-responses-GETapi-v1-validate-reset-token">
            <blockquote>
...
<span id="execution-results-GETapi-v1-validate-reset-token" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-validate-reset-token"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-validate-reset-token"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-validate-reset-token" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-validate-reset-token">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-validate-reset-token" data-method="GET"
      data-path="api/v1/validate-reset-token"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-validate-reset-token', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-validate-reset-token"
                    onclick="tryItOut('GETapi-v1-validate-reset-token');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-validate-reset-token"
                    onclick="cancelTryOut('GETapi-v1-validate-reset-token');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-validate-reset-token"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/validate-reset-token</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-validate-reset-token"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-validate-reset-token"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="token"                data-endpoint="GETapi-v1-validate-reset-token"
               value="architecto"
               data-component="body">
    <br>
<p>The <code>token</code> of an existing record in the password_reset_tokens table. Example: <code>architecto</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="confirm_password"                data-endpoint="POSTapi-v1-reset-password"
               value="architecto"
               data-component="body">
    <br>
<p>The value and <code>password</code> must match. Example: <code>architecto</code></p>
